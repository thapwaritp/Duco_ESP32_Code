...
String ducouser = "thapwaritp";          // Change this to your Duino-Coin username
String rigname  = "RIG01-TEST";         // Change this if you want to display a custom rig name in the Wallet

String AcctName = "thapwaritp";            //<-- ใส่ชือ User Name ตรงนี
String BrdNm    = "RIG01-001";             //<-- ใส่ชือ RigName ตรงนี
...
#define URL_fw_Version "https://raw.githubusercontent.com/thapwaritp/FW_ESP32/master/fw_version_aod.txt"
#define URL_fw_Bin "https://raw.githubusercontent.com/thapwaritp/FW_ESP32/master/fw_update_aod.bin"
...
void setup() {
  ...
  Serial.println("\n\n[[ Duino-Coin ESP32 Miner V.2.7.2 ]]");
